...
class CompanyDetails extends Component {
    ...
    componentWillMount() {
        let that = this;
        let jobs = [];
        firebase.database().ref('/accounts/Student/' + this.props.user.uid).once('value', (snapshot) => {
                    ...
                    (this.state.details) ?
                        <div>
                            <div className="list-group">
                                ...
                                <div className="card ">
                                    <h5 className="card-header">{this.props.user.displayName} - {this.state.details.position}</h5>
